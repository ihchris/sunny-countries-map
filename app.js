...
// Application State
const state = { mode: 'sunshine', unit: 'C', query: '', region: 'All', selectedName: null };
...
const els = {
  ...
  modeSunshine: document.getElementById('modeSunshine'), modeTemperature: document.getElementById('modeTemperature'),
  unitC: document.getElementById('unitC'), unitF: document.getElementById('unitF'),
  searchInput: document.getElementById('searchInput'), regionFilters: document.getElementById('regionFilters'),
  cardsGrid: document.getElementById('cardsGrid'), visibleCount: document.getElementById('visibleCount'),
  selectedName: document.getElementById('selectedName'), selectedMeta: document.getElementById('selectedMeta'), 
  selectedFlag: document.getElementById('selectedFlag'), selectedCurrentTemp: document.getElementById('selectedCurrentTemp'), 
  selectedFeelsLike: document.getElementById('selectedFeelsLike'), selectedHumidity: document.getElementById('selectedHumidity'), 
  selectedWind: document.getElementById('selectedWind'), selectedWeatherText: document.getElementById('selectedWeatherText')
};
